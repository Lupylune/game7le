...
await check('/classement?onglet=semaine', SEL_CLASSEMENT, 'Classement — semaine');
await check('/classement?onglet=mois', SEL_CLASSEMENT, 'Classement — mois');
await check('/classement?onglet=general', SEL_CLASSEMENT, 'Classement — général');
